...
import { fact, conversionBetweenDegRad } from "./modularMethods/MathematicalConversionOperations.js";
import { opInclude } from "./modularMethods/BooleanOperation.js";
import { replaceAll } from "./modularMethods/ReplacingStringOperation.js";
import { degreeRadianChange } from "./modularMethods/ReplacingStringOperation.js";
...
class Calculator{
    ...
    constructor(){
        ...
        document.getElementsByClassName('calculator-buttons')[0].addEventListener('click', (event)=>{
            this.handleClickOnCalculator(event);
        });

        document.getElementsByClassName('remove-data')[0].addEventListener('click', ()=>{
            this.removeDataFromInput();
        });

        document.getElementsByClassName('2nd-button')[0].addEventListener('click', (event)=>{
            this.handleSecondSetOfOperations(event);
        });

        document.getElementsByClassName('trig-func')[0].addEventListener('change', (event)=>{
            this.handleTrignometryFunction(event.target.value);
        });

        document.getElementsByClassName('advance-func')[0].addEventListener('change', (event)=>{
            this.handleAdvancedFunction(event.target.value);
        });

        document.getElementsByClassName('deg-rad-button')[0].addEventListener('click', (event)=>{
        ...
        document.getElementsByClassName('view-history')[0].addEventListener('click', ()=>{
            this.handleHistory();
        });

        document.getElementsByClassName('dark-light-button')[0].addEventListener('click', ()=>{
    ...
    handleClickOnCalculator(event) {
      ...
      handleSecondSetOfOperations(e) {
        document.getElementsByClassName('2nd-button')[0].classList.toggle("selected");
      ...
      showHistoryContent() {
        ...
        document.getElementsByClassName('clear-history-button')[0].addEventListener('click', ()=>{
