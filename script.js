...
document.addEventListener("keyup", (event) => {
  ...
  if (event.key === "Backspace" || event.key === "Delete") {
    if(calculatorInput.value === 'ERROR' || calculatorInput.value === 'Infinity'){
      calculatorInput.value = "";
    }
    else
...
function handleDarkLightMode(){
  ...
  document.getElementsByClassName('dark-light-button')[0].classList.toggle('selected');
  calculatorInput.classList.toggle('dark-calculator-input');
  document.body.classList.toggle('dark-body');
  document.getElementsByClassName('enclosing-calculator')[0].classList.toggle('dark-enclosing-calculator');
  document.getElementsByClassName('dark-light-button')[0].classList.toggle('selected');
  
  if(darkLightFlag === 0){
    darkLightFlag = 1;
    document.getElementsByClassName('view-history')[0].setAttribute('src', './images/history1.png');
    document.getElementsByClassName('dark-light-button')[0].setAttribute('src', './images/brightness-and-contrast1.png');
    document.getElementsByClassName('remove-data-icon')[0].setAttribute('src', './images/delete1.png');
    document.getElementsByClassName('trignometry-function-icon')[0].setAttribute('src', './images/right-triangle1.png');
    ...
    document.querySelectorAll('.trignometry-functions > div > select').forEach(e => {
      e.style.color = "white";
    });
    ...
    darkLightFlag = 0;
    document.getElementsByClassName('view-history')[0].setAttribute('src', './images/history.png');
    document.getElementsByClassName('dark-light-button')[0].setAttribute('src', './images/brightness-and-contrast.png');
    document.getElementsByClassName('remove-data-icon')[0].setAttribute('src', './images/delete.png');
    document.getElementsByClassName('trignometry-function-icon')[0].setAttribute('src', './images/right-triangle.png');
    document.querySelectorAll('.calculator-buttons > div').forEach(e => {
